...
class GameSession:
    def __init__(self, game_id: int, white_player_id: int, black_player_id: int):
...
class GameManager:
    ...
    def create_session(self, game_id: int, white_player_id: int, black_player_id: int) -> GameSession:
        session = GameSession(game_id, white_player_id, black_player_id)
