...
class GameUI:
    ...
    def _set_up_pause_ui(self):
        ...
        self._resume_button = arcade.gui.UIFlatButton(text="RESUME", y=420, x=40, width=225, style=self.button_style)
        self._pause_widget.add(self._resume_button)
        
        self._restart_button = arcade.gui.UIFlatButton(text="RESTART", y=360, x=40, width=250, style=self.button_style)
        self._pause_widget.add(self._restart_button)
        
        self._main_menu_button = arcade.gui.UIFlatButton(text="MAIN MENU", y=300, x=40, width=285, style=self.button_style)
