...
class MultiplayerMenuView(arcade.View):
    def __init__(self):
        ...
        self._white_pawn = arcade.gui.UIImage(texture=white_piece, width=108, height=144, y=450, x=130, angle=340)
        self._black_pawn = arcade.gui.UIImage(texture=black_piece, width=108, height=144, y=450, x=550, angle=20)
